...
function getWrittenData(): DataFile {
  ...
  if (!callData) throw new Error("No written data found in mock calls")
  ...
  projects: [
    {
      ...
      color: "#3b82f6",
      shared: false,
      taskOrder: [createTaskId("11111111-1111-4111-8111-111111111111")],
      sections: [],
    },
    {
      ...
      color: "#ef4444",
      shared: false,
      taskOrder: [createTaskId("22222222-2222-4222-8222-222222222222")],
      sections: [],
    },
  ],
  labels: [
