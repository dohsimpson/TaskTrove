...
vi.mock("@/lib/atoms", () => ({
  ...
  exitSelectionModeAtom: vi.fn(),
  clearSelectionAtom: vi.fn(),
  selectAllVisibleTasksAtom: vi.fn(),
  allVisibleTasksSelectedAtom: vi.fn(),
  bulkCompleteTasksAtom: vi.fn(),
  bulkDeleteTasksAtom: vi.fn(),
  bulkMoveTasksAtom: vi.fn(),
  bulkSetPriorityAtom: vi.fn(),
  bulkScheduleTasksAtom: vi.fn(),
