...
import type { ProjectGroup, GroupId, ProjectId } from "@/lib/types"
import { isGroup, GroupIdSchema } from "@/lib/types"
 ...
 */
export function findGroupById(group: ProjectGroup, id: GroupId): ProjectGroup | null {
