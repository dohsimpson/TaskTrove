...
function ViewOptionsPopoverComponent({ className }: ViewOptionsProps) {
            ...
            content={
              <div className="space-y-3">
                ...
                <ul className="list-disc pl-4 space-y-1">
                  ...
                  <li>
                    <strong>Display Options:</strong> Toggle completed tasks, side panel, and
                    compact view
                  </li>
                  <li>
              ...
              <HelpPopover
                ...
                content={
                  <div className="space-y-3">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      <li>
                        <strong>Completed Tasks:</strong> Show or hide tasks that have been
                        completed
                      </li>
                      <li>
                        <strong>Side Panel:</strong> Toggle the side panel for additional task
                        details
                      </li>
                      <li>
              ...
              <HelpPopover
                ...
                content={
                  <div className="space-y-3">
                    ...
                    <div className="mt-3 p-2 bg-muted rounded-md">
                      <p className="text-sm text-muted-foreground">
                        💡 Tip: Use the arrow button to toggle between ascending and descending
                        order
                      </p>
                    </div>
                  </div>
