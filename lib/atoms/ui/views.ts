  ...
  createDefaultViewStates(),
  {
    ...
    deserialize: (str) => {
      ...
      try {
        ...
        log.error({ error, module: "views" }, "Error parsing JSON for view states")
        return {}
      }
 ...
 */
export const setViewModeAtom = atom(null, (get, set, mode: "list" | "kanban" | "calendar") => {
 ...
 */
export const setViewOptionsAtom = atom(null, (get, set, updates: Partial<ViewState>) => {
...
export const setSortingAtom = atom(
  null,
  (get, set, { sortBy, sortDirection }: { sortBy?: string; sortDirection?: "asc" | "desc" }) => {
 ...
 */
export const toggleSectionCollapseAtom = atom(null, (get, set, sectionId: string) => {
 ...
 */
export const setActiveFiltersAtom = atom(null, (get, set, filters: ViewState["activeFilters"]) => {
 ...
 */
export const toggleTaskPanelWithViewStateAtom = atom(null, (get, set, task: Task) => {
  ...
  if (isCurrentlyOpen && currentTaskId === task.id) {
    ...
    set(updateViewStateAtom, { viewId: currentView, updates: { showSidePanel: false } })
  } else {
    ...
    if (!currentViewState.showSidePanel) {
      set(updateViewStateAtom, { viewId: currentView, updates: { showSidePanel: true } })
    }
  }
})
toggleTaskPanelWithViewStateAtom.debugLabel = "toggleTaskPanelWithViewStateAtom"
