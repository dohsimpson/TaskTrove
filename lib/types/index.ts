...
import { validateRRule } from "@/lib/utils/validation"
...
export const createProjectId = (id: string): ProjectId => ProjectIdSchema.parse(id)
export const createLabelId = (id: string): LabelId => LabelIdSchema.parse(id)
export const createSubtaskId = (id: string): SubtaskId => SubtaskIdSchema.parse(id)
 ...
 */
export const INBOX_PROJECT_ID = createProjectId("00000000-0000-0000-0000-000000000000")
export const TODAY_PROJECT_ID = createProjectId("11111111-1111-1111-8111-111111111111")
export const UPCOMING_PROJECT_ID = createProjectId("22222222-2222-2222-8222-222222222222")
export const COMPLETED_PROJECT_ID = createProjectId("33333333-3333-3333-8333-333333333333")
export const ALL_PROJECT_ID = createProjectId("44444444-4444-4444-8444-444444444444")
export const ANALYTICS_PROJECT_ID = createProjectId("55555555-5555-5555-8555-555555555555")
export const SEARCH_PROJECT_ID = createProjectId("66666666-6666-6666-8666-666666666666")

/**
 * Helper function to ensure a task has a projectId, defaulting to inbox if not specified
 */
export function ensureTaskProjectId(task: Task): Task & { projectId: ProjectId } {
  return {
    ...task,
    ...
    .object({
      ...
      dueDateFilter: z
        .object({
          ...
          preset: z
            .enum(["overdue", "today", "tomorrow", "thisWeek", "nextWeek", "noDueDate"])
            .optional(),
          /** Custom date range */
          customRange: z
            .object({
...
export type RRuleFrequencyType = (typeof RRuleFrequency)[keyof typeof RRuleFrequency]
...
export const CommonRRules = {
  ...
  everyNDays: (n: number) => buildRRule({ freq: RRuleFrequency.DAILY, interval: n }),
  everyNWeeks: (n: number) => buildRRule({ freq: RRuleFrequency.WEEKLY, interval: n }),
  everyWeekday: () =>
    buildRRule({
      freq: RRuleFrequency.WEEKLY,
      byday: [RRuleWeekday.MO, RRuleWeekday.TU, RRuleWeekday.WE, RRuleWeekday.TH, RRuleWeekday.FR],
    }),
  everyWeekend: () =>
    buildRRule({
      freq: RRuleFrequency.WEEKLY,
  ...
  everyMonday: () => buildRRule({ freq: RRuleFrequency.WEEKLY, byday: [RRuleWeekday.MO] }),
  everyTuesday: () => buildRRule({ freq: RRuleFrequency.WEEKLY, byday: [RRuleWeekday.TU] }),
  everyWednesday: () => buildRRule({ freq: RRuleFrequency.WEEKLY, byday: [RRuleWeekday.WE] }),
  everyThursday: () => buildRRule({ freq: RRuleFrequency.WEEKLY, byday: [RRuleWeekday.TH] }),
  everyFriday: () => buildRRule({ freq: RRuleFrequency.WEEKLY, byday: [RRuleWeekday.FR] }),
  everySaturday: () => buildRRule({ freq: RRuleFrequency.WEEKLY, byday: [RRuleWeekday.SA] }),
  everySunday: () => buildRRule({ freq: RRuleFrequency.WEEKLY, byday: [RRuleWeekday.SU] }),
  nTimes: (freq: RRuleFrequencyType, count: number) => buildRRule({ freq, count }),
  untilDate: (freq: RRuleFrequencyType, until: string) => buildRRule({ freq, until }),
} as const
...
export const TaskSchema = z.object({
  ...
  /** Mode for calculating next due date in recurring tasks */
  recurringMode: z.union([z.literal("completedAt")]).optional(),
...
export const TaskCreateArraySerializationSchema = z.array(TaskCreateSerializationSchema)
...
export const ProjectCreateSerializationSchema = ProjectSerializationSchema.partial()
  .omit({
    id: true,
  })
  .required({
...
export const ProjectCreateArraySerializationSchema = z.array(ProjectCreateSerializationSchema)
...
export const LabelCreateArraySerializationSchema = z.array(LabelCreateSerializationSchema)
...
export const ProjectUpdateSerializationSchema = ProjectSerializationSchema.partial().required({
  id: true,
})
export const ProjectUpdateArraySerializationSchema = z.array(ProjectUpdateSerializationSchema)
...
export const LabelUpdateSerializationSchema = LabelSerializationSchema.partial().required({
  id: true,
})
...
export const TaskDeleteSerializationSchema = TaskSerializationSchema.pick({ id: true })
export const TaskDeleteArraySerializationSchema = z.array(TaskDeleteSerializationSchema)
...
export const ProjectDeleteSerializationSchema = z.object({ id: ProjectIdSchema })
export const ProjectDeleteArraySerializationSchema = z.array(ProjectDeleteSerializationSchema)
...
export const LabelDeleteArraySerializationSchema = z.array(LabelDeleteSerializationSchema)
 ...
 */
export function isValidViewMode(value: unknown): value is "list" | "kanban" | "calendar" {
  return typeof value === "string" && ["list", "kanban", "calendar"].includes(value)
}
